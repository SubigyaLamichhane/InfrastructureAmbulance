...
export type ComplainsByUserQuery = { __typename?: 'Query', complainsByUser: { __typename?: 'PaginatedComplains', hasMore: boolean, complains: Array<{ __typename?: 'Complain', id: number, wardNo: number, descriptionSnippet: string, title: string, createdAt: string, imagePublicId: string }> } };
